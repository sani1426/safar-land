    ...
    return ( 
        ...
        <div class="nav-side">
          <ul class="nav_list_side">
            <li class="nav-item nav_item_side"><a href="#">خانه</a></li>
            <li class="nav-item nav_item_side"><a href="#">درباره ما</a></li>
            <li class="nav-item nav_item_side"><a href="#">تماس با ما</a></li>
